...
class SemData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.mode == 'train':
            ...
            return image, label, label_b, s_x, s_y,  subcls_list, raw_label, raw_label_b, class_chosen, image_path, label_path, support_image_path_list, support_label_path_list
        elif self.mode == 'demo':
